...
public class healthKnowledge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Answer1 = findViewById(R.id.firstHealthAnswer);
        Answer2 = findViewById(R.id.secondHealthAnswer);
        Answer3 = findViewById(R.id.thirdHealthAnswer);

        Button question1Button = (Button) findViewById(R.id.firstHealthQuestion);
        Button question2Button = (Button) findViewById(R.id.secondHealthQuestion);
        Button question3Button = (Button) findViewById(R.id.thirdHealthQuestion);
